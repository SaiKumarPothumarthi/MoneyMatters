...
const OverviewChart = ({ lastSevenDaysData }) => {
  ...
  return (
    <div className="overviewChart">
      <p className="overviewChart-para">
        <span className="overviewChart-span">${totalData.debit.toLocaleString()} </span>
        Debited
        <span className="overviewChart-span"> ${totalData.credit.toLocaleString()} </span>
